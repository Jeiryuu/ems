...
<head>
    ...
    <style>
  .avatar {
    width: 120px; /* Set the desired width for the circle */
    height: 120px; /* Set the desired height for the circle */
...
<body>
    ...
    <img src="<?php echo $userprofile; ?>" class="text-center img img-fluid rounded-circle avatar" alt="Profile Picture">
</div>
