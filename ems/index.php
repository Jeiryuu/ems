...
<body>
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="user">
        <img class="img img-fluid rounded-circle avatar" src="<?php echo $userprofile ?>" alt="Profile Picture">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="manage_expense.php" class="list-group-item list-group-item-action "><span data-feather="check-square"></span> Manage Expenses</a>
      </div>
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col text-center">
                    <a href="add_expense.php"><img src="icon/add-payment.png" width="57px" />
                      <p>Add Expenses</p>
                    </a>
                  </div>
                  <div class="col text-center">
                    <a href="manage_expense.php"><img src="icon/money-bag.png" width="57px" />
                      <p>Manage Expenses</p>
                    </a>
                  </div>
                  <div class="col text-center">
